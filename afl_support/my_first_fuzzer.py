...
START_ADDRESS = 0xaaaaa4e8 # TODO: Set start address here
END_ADDRESS = 0xaaaaa5bc # TODO: Set end address here
...
def main():
    ...
    if args.input_file:
        ...
        # No constraints on the mutated inputs have been set

        # input_content_len = struct.unpack("<I", input_content)[0]
        ...
        # The mutated input was not loaded into the Unicorn state

        uc.reg_write(UC_ARM_REG_R1, buf_addr)
